...
from utils.util import model_utils, test_Net
from configs.config import MyConfiguration
from models.MobileNet import MobileNet_test, MobileNet
from models.ShuffleNet import ShuffleNet, ShuffleSeg
import math
'''
...
if __name__ == '__main__':
    ...
    model = MobileNet(config=config)
    model_utils = model_utils(model=model, config=config)

    #for name, module in model.named_children():
    #   print(name, module)
    #names = model_utils.get_names_dict()
    model_utils.simulate_forward()